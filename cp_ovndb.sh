...
# copy DB
oc cp openshift-ovn-kubernetes/"${leader_pod}":/etc/ovn/ovnsb_db.db -c sbdb ./sbdb.db
oc cp openshift-ovn-kubernetes/"${leader_pod}":/etc/ovn/ovnnb_db.db -c nbdb ./nbdb.db
